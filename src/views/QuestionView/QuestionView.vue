...
import CodeBlock from '@features/quiz/CodeBlock/CodeBlock.vue'
import ProgressBar from '@features/quiz/ProgressBar/ProgressBar.vue'
...
<template>
  <UPageContainer max-width="3xl" padding-y="8">
    <div class="mb-8 flex items-center justify-between">
      ...
      <UButton variant="ghost" size="sm" @click="handleExit">
        Exit
      </UButton>
    </div>
    ...
    <UCard v-if="currentQuestion" class="mt-8 sm:p-8">
      <div class="mb-4 flex items-center gap-2">
        <UBadge variant="count" class="capitalize">
          {{ currentQuestion.difficulty }}
        </UBadge>
        <UBadge v-for="tag in currentQuestion.tags" :key="tag" variant="tag">
          {{ tag }}
        </UBadge>
      </div>
      ...
      <div class="mt-6 space-y-3">
        ...
        >
          <span
            class="flex h-7 w-7 shrink-0 items-center justify-center rounded-full border-2 text-xs font-bold transition-all"
      ...
      <div class="mt-6 flex justify-end">
        ...
        <UButton v-else size="lg" @click="handleNext">
